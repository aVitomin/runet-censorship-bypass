...
2. Уже выбран проверенный декларативный набор Anticensority. В Firefox он
   задаёт правила маршрутизации; дополнительные расширенные PAC-источники
   доступны в Chromium.
...
Настройки Firefox можно менять при активной защите. **Сохранить настройки**
сохраняет изменения, но не меняет действующую маршрутизацию; затем нажмите
**Применить сохранённые настройки**. Расширение не выключает активную защиту
...
Firefox использует включённые в пакет проверенные декларативные данные
Anticensority, а не исполняет PAC-код. Эти данные задают правила, но не
...
декларативные данные; расширенные пользовательские PAC-источники доступны в
Chromium.
...
В обоих браузерах сохраните изменение и используйте общую кнопку применения.
Сохранение не применяет правило автоматически и не требует выключать защиту.
...
host or domain scope. Saving and applying are separate in both browsers: Save
records settings and Apply makes them active without turning protection off.
Firefox uses verified declarative Anticensority provider data; compatible local
